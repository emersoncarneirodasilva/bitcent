...
export default function Slogan() {
      ...
      >
        ...
        <div className="flex gap-2.5">
          ...
          >
            ...
            <span className="relative z-20 rotate-2">dinheiro</span>
          </span>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col justify-center gap-5">
      {renderizarFrase()}
      <div className="text-sm font-thin text-center lg:text-lg text-zinc-500 sm:text-left">
