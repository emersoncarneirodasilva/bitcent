  ...
  return (
    ...
    >
      <div className={`flex flex-col justify-center items-center`}>
        <h2 className="text-2xl font-thin text-center text-zinc-600 sm:text-4xl mb-11">
          As pessoas estão dizendo...
        </h2>
        <div className="flex flex-wrap items-center justify-center w-full xl:justify-between justify-items-center gap-7">
          <Depoimento
